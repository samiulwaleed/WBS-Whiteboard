...
async function beforeEach(browser, done) {
    data_path = await fs.promises.mkdtemp(path.join(os.tmpdir(), 'WFR-test-data-'));
    process.env["PORT"] = PORT;
    process.env["WFR_HISTORY_DIR"] = data_path;
    console.log("Launching WFR in " + data_path);
    WFR = require("../server/server.js");
    done();
}
